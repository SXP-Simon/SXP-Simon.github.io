---
author: Helian
pubDatetime: 2026-08-20T16:30:00Z
...
<div class="flex flex-wrap items-center gap-6 my-6 p-5 rounded-2xl border border-border bg-foreground/5 not-prose">
  <div class="flex items-center gap-2">
    ...
    <span class="font-medium">Lucide</span>
  </div>
  <div class="flex items-center gap-2">
...
### CodePen 在线可交互代码编辑器（`<CodePen />`）
读者可直接在博文内查看前端动效，甚至实时修改 CSS/JS 进行调试：
...
在博文中推荐开源项目或展示自己的代码仓库，自动渲染徽章与项目信息：
