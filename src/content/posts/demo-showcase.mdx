...
支持官方单曲、专辑、歌单以及**社区/播客声音（电台节目）**嵌入，无需离开博文即可在线试听：

#### 示例 1：官方单曲（川田まみ《Wings of Courage -空を超えて-》）
<NetEaseMusic 
  id="32098307" 
...
#### 示例 2：社区声音 / 电台播客（Vivy 插曲「E P」）
<NetEaseMusic 
  type="program" 
  id="2488308450" 
  title="Vivy -Fluorite Eyes Song- 第四话 插入歌「E P」" 
